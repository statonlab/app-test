      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.textBody}>All observations submitted to our database will be stored on the TreeSnap website. This includes all data and metadata, including GPS coordinates, and images. Observation data will be displayed on the TreeSnap website, and be made available to outside parties through an API. Observations can be made anonymous in the profile settings of the app or website: anonymous observations will only be visible to you and the scientists behind TreeSnap.
            </Text>
          </View>
          <View style={styles.card}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.textBody}> As TreeSnap evolves, we may make changes to our data usage and privacy policy. We will never show, sell, or disseminate your personal information to any outside parties not affiliated with tree research programs.
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.textBody}> By using this app you agree that you will not collect observations for trees on private land without permission. Observations may only be submitted for trees on public land, trees on the user's own private land, or trees on other private land for which the user has obtained all necessary permissions from the private land owner.
            </Text>
            <Text style={styles.textBody}>
              By submitting observations using the TreeSnap app, you affirm that the tree is on public land, or that you own the private land the tree is located on or have permission to use the private land.</Text>
            <Text style={styles.textBody}>
