    ...
    descriptionCards: [
      ...
      },
      {
        ...
        body : [
          ...
          <Text style={styles.paragraph}>Oblong leaves are thick and leathery with a wavy-toothed border, shiny light green above, whitish beneath, 6-13 cm long, 2-6 cm wide. Flowers are unisexual, male flowers are in catkins 5-10 cm long, white but turning rust colored, with an unpleasant odor; greenish-yellow female flowers are found at the base of catkins. Acorns are egg-shaped, 2-3 cm long, shallow saucer-shaped cup, covered with dense bristles; mature in the second year. From OSU landscape plants; <Atext
            url="https://landscapeplants.oregonstate.edu/plants/notholithocarpus-densiflorus">https://landscapeplants.oregonstate.edu/plants/notholithocarpus-densiflorus</Atext></Text>,
        ],
      },
      {
        title: 'Challenges',
        body : [
          ...
          <Text style={styles.paragraph}>For additional information refer to Sudden Oak Death: Prevention, Recognition, Restoration (EM 9216) <Atext
            url="https://catalog.extension.oregonstate.edu/em9216">https://catalog.extension.oregonstate.edu/em9216</Atext></Text>,
        ],
      },
    ],
    formProps       : {
